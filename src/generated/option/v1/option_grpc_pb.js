...
var option_v1_option_pb = require('../../option/v1/option_pb.js');

function serialize_jax_v1_GetDexByStrikesRequest(arg) {
  if (!(arg instanceof option_v1_option_pb.GetDexByStrikesRequest)) {
...
function deserialize_jax_v1_GetDexByStrikesRequest(buffer_arg) {
  return option_v1_option_pb.GetDexByStrikesRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_jax_v1_GetDexRequest(arg) {
  if (!(arg instanceof option_v1_option_pb.GetDexRequest)) {
...
function deserialize_jax_v1_GetDexRequest(buffer_arg) {
  return option_v1_option_pb.GetDexRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_jax_v1_GetDexResponse(arg) {
  if (!(arg instanceof option_v1_option_pb.GetDexResponse)) {
...
function deserialize_jax_v1_GetDexResponse(buffer_arg) {
  return option_v1_option_pb.GetDexResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
getDex: {
    ...
    requestType: option_v1_option_pb.GetDexRequest,
    responseType: option_v1_option_pb.GetDexResponse,
...
getDexByStrikes: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: option_v1_option_pb.GetDexByStrikesRequest,
    responseType: option_v1_option_pb.GetDexResponse,
